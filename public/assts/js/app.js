 ...
 */
	...
	// nom:nom_doctor,
	//prenom :prenom_doctor,
	//datenaissance: datenaissance_doctor,
	//email:email_doctor,
	//pays:pays_doctor,
   // capitale:capitale_doctor,
   // adresse :adresse_doctor,
	// telephone:telephone_doctor,
	// genre:genre_doctor,
	// file:formData
...
/* use Symfony\Component\HttpFoundation\File\Filesystem;
...
public function uploadAction(Request $request)
{
    ...
    $uploadedFile = new UploadedFile($file->getPathname(), $file->getClientOriginalName(), $file->getClientMimeType(), $file->getClientSize(), null, true);

    // Définir le chemin de destination
    $chemin = $this->getParameter('dossier_upload').'/'.$uploadedFile->getClientOriginalName();

    // Déplacer le fichier uploadé vers le chemin de destination
    $filesystem = new Filesystem();
    $filesystem->mkdir(dirname($chemin));
    $uploadedFile->move(dirname($chemin), basename($chemin));

    // Ajouter le chemin du fichier à l'entité
    $entity->setCheminFichier($chemin);
